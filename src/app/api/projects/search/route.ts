...
export async function POST(request: NextRequest) {
  try {
    ...
    if (budgetMin !== undefined && budgetMin !== null) {
      where.budget = { ...(where.budget as Prisma.FloatNullableFilter || {}), gte: parseFloat(budgetMin) };
    }
    if (budgetMax !== undefined && budgetMax !== null) {
      where.budget = { ...(where.budget as Prisma.FloatNullableFilter || {}), lte: parseFloat(budgetMax) };
    }
