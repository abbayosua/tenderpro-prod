    ...
    <div className="space-y-6">
      ...
      <Card className="border-2 border-primary/20">
        ...
        <CardContent className="space-y-4">
          <HealthBar label="Tingkat Verifikasi" value={data.healthMetrics.verificationRate} color="blue" />
          <HealthBar label="Tingkat Penyelesaian Proyek" value={data.healthMetrics.completionRate} color="green" />
          <HealthBar label="Tingkat Penerimaan Bid" value={data.healthMetrics.acceptanceRate} color="purple" />
          <HealthBar label="Tingkat Sengketa Aktif" value={100 - data.healthMetrics.openDisputeRate} color="amber" />
        </CardContent>
      </Card>
